...
class ExcelDataset(Dataset):
    ...
    def __getitem__(self, idx):
        return self.features1[idx], self.features2[idx], self.x[idx], self.y[idx],self.H[idx]